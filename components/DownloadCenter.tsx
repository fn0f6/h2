    ...
    <section id="downloads" className="py-24 bg-ocean-950 scroll-mt-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-[3rem] overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.9)] border border-wood-500/20 group">
            <div className="absolute inset-0 bg-cover bg-center z-0 opacity-10 group-hover:scale-105 transition-transform duration-[2000ms]" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1516666991959-1e3c88015c2d?auto=format&fit=crop&q=80&w=2000')" }}></div>
